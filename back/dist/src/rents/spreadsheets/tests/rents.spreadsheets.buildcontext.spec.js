...
describe('testing removing unusedEstates', () => {
    it('should return no unusedEstates', async () => {
        ...
        const estates = [];
        const unusedEstates = (0, spreadsheets_utils_1.getUnusedEstates)(spreadSheet, estates);
    ...
    it('should return no unusedEstates', async () => {
        ...
        const unusedEstates = (0, spreadsheets_utils_1.getUnusedEstates)(spreadSheet, [estate]);
        expect(unusedEstates.length).toEqual(0);
    });
    ...
    it('should return no missingRows', async () => {
        ...
        const estates = [];
        const missingEstates = (0, spreadsheets_utils_1.getMissingRows)(spreadSheet, estates);
