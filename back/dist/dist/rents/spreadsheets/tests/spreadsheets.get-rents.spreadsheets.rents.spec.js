...
describe('updating spreadsheet after building context', () => {
    ...
    it('build a spreadsheet and update a rent', async () => {
        ...
        const sheetsUpdates = (0, rents_spreadsheets_utils_1.getPaidUpdatesRentsCells)(spreadSheet, [{ ...rents_mocks_1.rent2024_02 }], [{ ...estates_mocks_1.estate1 }]);
    ...
    it('build a spreadsheet and update 2 rents', async () => {
        ...
        const sheetsUpdates = (0, rents_spreadsheets_utils_1.getPaidUpdatesRentsCells)(spreadSheet, [{ ...rents_mocks_1.rent2024_02 }, { ...rents_mocks_1.rent2024_03 }], [{ ...estates_mocks_1.estate1 }]);
        expect(sheetsUpdates[0].sheetTitle).toEqual('2024');
        expect(sheetsUpdates[0].cell).toEqual('G2');
        expect(sheetsUpdates[0].value).toEqual(1100);
        expect(sheetsUpdates[0].backgroundColor.green).toEqual(1);
    ...
    it('build a spreadsheet and update 3 rents', async () => {
        ...
        const { spreadSheet } = await (0, rents_spreadsheets_business_1.buildSpreadsheetContext)(mockedGoogleWorker, null, [{ ...estates_mocks_1.estate1 }], startDate, endDate);
        const sheetsUpdates = (0, rents_spreadsheets_utils_1.getPaidUpdatesRentsCells)(spreadSheet, [{ ...rents_mocks_1.rent2024_02 }, { ...rents_mocks_1.rent2024_03 }, { ...rents_mocks_1.rent2024_04 }], [{ ...estates_mocks_1.estate1 }]);
        expect(sheetsUpdates[0].sheetTitle).toEqual('2024');
        expect(sheetsUpdates[0].cell).toEqual('G2');
        expect(sheetsUpdates[0].value).toEqual(1100);
        expect(sheetsUpdates[0].backgroundColor.green).toEqual(1);
    ...
    it('build a spreadsheet and update 2 rents in 2 differents estates', async () => {
        ...
        const sheetsCells = (0, rents_spreadsheets_utils_1.getPaidUpdatesRentsCells)(spreadSheet, rents, [...estates]);
...
//# sourceMappingURL=spreadsheets.get-rents.spreadsheets.rents.spec.js.map