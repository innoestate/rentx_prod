...
exports.AddSentInRents1734594815085 = void 0;
class AddSentInRents1734594815085 {
    constructor() {
        this.name = 'AddSentInRents1734594815085';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "rents" ADD "sent" boolean NOT NULL DEFAULT false`);
    }
    async down(queryRunner) {
        await queryRunner.query(`ALTER TABLE "rents" DROP COLUMN "sent"`);
...
exports.AddSentInRents1734594815085 = AddSentInRents1734594815085;
//# sourceMappingURL=1734594815085-addSentInRents.js.map